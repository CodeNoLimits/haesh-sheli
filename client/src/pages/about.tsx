...
const translations = {
  he: {
    ...
    founderBio: 'יעקב הוא מפתח Full-Stack מנוסה עם תשוקה עמוקה להפצת הספרות הברסלבית. עם מעל 8 שנות ניסיון בפיתוח אתרים מתקדמים, יעקב הקדיש את כישוריו הטכניים למשימה קדושה: לייצר מהפכה דיגיטלית בעולם הספרות היהודית. בהשראת תורת רבי נחמן מברסלב על השמחה והתקווה, יעקב מאמין שטכנולוגיה יכולה לחבר בין אנשים לחכמה העתיקה.',
    founderMission: 'החזון שלי פשוט: כל יהודי בעולם צריך לקבל גישה קלה ונוחה לחכמת רבי נחמן. הטכנולוגיה היא הכלי, האור הברסלבי הוא המטרה. כמו שאמר רבי נחמן: "אין שום ייאוש בעולם כלל" - גם בטכנולוגיה יש תקווה גדולה.',
