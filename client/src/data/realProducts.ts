...
export const realBreslovProducts: Record<string, Product> = {
  ...
  'kitzur-likutei-moharan': {
    ...
    nameFrench: 'Résumé de Likouté Moharan',
    nameSpanish: 'Resumen de Likutei Moharán',
    nameRussian: 'Краткое изложение Ликутей Моаран',
  ...
  'likutei-tefilot': {
    ...
    nameFrench: 'Recueil de Prières',
    nameSpanish: 'Colección de Oraciones',
    nameRussian: 'Сборник Молитв',
  ...
  'siporei-masiyot': {
    ...
    nameFrench: 'Contes du Rabbi Nachman',
    nameSpanish: 'Cuentos del Rabí Najmán',
    nameRussian: 'Рассказы Рабби Нахмана',
  ...
  'sefer-hamidot': {
    ...
    nameFrench: 'Le Livre des Traits de Caractère',
    nameSpanish: 'El Libro de las Cualidades',
  ...
  'hishtapchut-hanefesh': {
    ...
    nameFrench: 'Épanchement de l\'Âme',
    nameSpanish: 'Derramamiento del Alma',
  ...
  'likutei-halakhot': {
    ...
    nameFrench: 'Likouté Halakhot',
    nameSpanish: 'Likutei Halajot',
    nameRussian: 'Ликутей Алахот',
  ...
  'likutei-etzot': {
    ...
    nameFrench: 'Likouté Etzot',
    nameSpanish: 'Likutei Etzot',
    nameRussian: 'Ликутей Эцот',
  ...
  'chayei-moharan': {
    ...
    nameFrench: 'Vie de Rabbi Nachman',
    nameSpanish: 'Vida de Rabí Najmán',
    nameRussian: 'Жизнь Рабби Нахмана',
  ...
  'yimei-maharanat': {
    ...
    nameFrench: 'Jours de Rabbi Nathan',
    nameSpanish: 'Días de Rabí Natán',
    nameRussian: 'Дни Рабби Натана',
  ...
  'ki-naar-yisrael': {
    ...
    nameFrench: 'Car Israël est Jeune',
    nameSpanish: 'Porque Israel es Joven',
  ...
  'toda-vehodaa': {
    ...
    nameFrench: 'Merci et Gratitude',
    nameSpanish: 'Gracias y Gratitud',
    nameRussian: 'Благодарность',
  ...
  'hatchalat-hathchlatot': {
    ...
    nameFrench: 'Commencement des Commencements',
    nameSpanish: 'Comienzo de los Comienzos',
  ...
  'hitgalut-hadaat': {
    ...
    nameFrench: 'Révélation de la Connaissance',
    nameSpanish: 'Revelación del Conocimiento',
  ...
  'otzer-hayirah': {
    ...
    nameFrench: 'Trésor de la Crainte du Ciel',
    nameSpanish: 'Tesoro del Temor al Cielo',
    nameRussian: 'Сокровищница Страха Небесного',
  ...
  'kol-bo-leyeshuot': {
    ...
    nameFrench: 'Tout pour les Saluts',
    nameSpanish: 'Todo para las Salvaciones',
    nameRussian: 'Все для Спасения',
  ...
  'tikkun-haklali': {
    ...
    nameFrench: 'Tikoun HaKlali',
    nameSpanish: 'Tikún HaKlali',
    nameRussian: 'Тикун Аклали',
  ...
  'yekara-deshabbata': {
    ...
    nameFrench: 'Gloire du Chabbat',
    nameSpanish: 'Gloria del Shabat',
    nameRussian: 'Слава Шаббата',
  ...
  'yareach-haeitanim': {
    ...
    nameFrench: 'Lune des Forts',
    nameSpanish: 'Luna de los Fuertes',
    nameRussian: 'Луна Сильных',
  ...
  'maafer-lefaar': {
    ...
    nameFrench: 'De la Cendre à la Gloire',
    nameSpanish: 'De la Ceniza a la Gloria',
    nameRussian: 'От Праха к Славе',
  ...
  'mem-tet-shaarim': {
    ...
    nameFrench: '49 Portes',
    nameSpanish: '49 Puertas',
    nameRussian: '49 Врат',
  ...
  'sod-harashbi': {
    ...
    nameFrench: 'Secret de Rabbi Shimon Bar Yochai',
    nameSpanish: 'Secreto de Rabí Shimón Bar Yojai',
    nameRussian: 'Тайна Рабби Шимона Бар Йохая',
  ...
  'shaar-hachamishim': {
    ...
    nameFrench: 'La Cinquantième Porte',
    nameSpanish: 'La Puerta Cincuenta',
    nameRussian: 'Пятидесятые Врата',
  ...
  'nachal-novea': {
    ...
    nameFrench: 'Ruisseau Jaillissant',
    nameSpanish: 'Arroyo Manante',
    nameRussian: 'Бьющий Ручей',
  ...
  'sichos-vehitorerut': {
    ...
    nameFrench: 'Conversations et Éveil',
  ...
  'mikhtavei-rabbi-natan-tiveria': {
    ...
    nameSpanish: 'Cartas de Rabí Natán de Tiberíades',
  ...
  'parparaot-al-hashas': {
    ...
    nameFrench: 'Papillons sur le Talmud',
    nameSpanish: 'Mariposas sobre el Talmud',
    nameRussian: 'Бабочки на Талмуде',
  ...
  'maayen-hamitgaber': {
    ...
    nameFrench: 'Source Croissante',
    nameSpanish: 'Fuente Creciente',
    nameRussian: 'Растущий Источник',
  ...
  'shema-yisrael': {
    ...
    nameFrench: 'Écoute Israël',
    nameSpanish: 'Escucha Israel',
    nameRussian: 'Слушай Израиль',
  ...
  'emunat-itecha': {
    ...
    nameFrench: 'Foi de Ton Temps',
    nameSpanish: 'Fe de Tu Tiempo',
    nameRussian: 'Вера Твоего Времени',
  ...
  'rabbenu-hakadosh': {
    ...
    nameFrench: 'Notre Saint Maître',
    nameSpanish: 'Nuestro Santo Maestro',
    nameRussian: 'Наш Святой Учитель',
